...
4) The folder 'Model architecture and trained weights' contains the actor's architecture as a json file and the trained weights after 750 episodes of 500 iterations each. Give the path of these two files in the evaluatemodel.py script to observe the performance of my training.
